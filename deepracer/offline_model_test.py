...
def main():
    ...
    for line in reader_csv:
        ...
        if args.OpenVINO:
            ...
            net_v_array.append(output[0][0])
            net_w_array.append(output[0][1])

            total_loss_v = total_loss_v + abs(float(line[1])-output[0][0]) 
            total_loss_w = total_loss_w + abs(float(line[2])-output[0][1])
        else:
    ...
    print("Tiempo medio:"+str(total_time/(count-start_measure_iter)))
